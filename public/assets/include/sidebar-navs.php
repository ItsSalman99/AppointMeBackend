            ...
            <div class="logo bg-white w-100 text-center p-3 d-none d-md-block position-relative" style="border-bottom: 1px solid var(--bs-gray-200);">
                <div class="d-flex align-items-cener justify-content-center h-50">
                    <a href="index.php" class="d-inline-flex">
                        <img src="assets/images/bookinglogo.png" alt="" class="mx-auto">
                    </a>
                </div>
            </div>
            <!-- sidemenu links -->
                ...
                <div class="sb-sidenav-menu">
                    <div class="cover-nav height-100vh px-4">
                        <div class="nav">
                            ...
                            <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'home.php') !== false) echo 'active'; ?>" href="home.php">
                                <div class="sb-nav-link-icon"><i class="bi bi-grid-1x2-fill font-20px"></i></div>
                                Dashboard
                            </a>
                            <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'calendar.php') !== false) echo 'active'; ?>" href="calendar.php">
                                <div class="sb-nav-link-icon"><i class="bi bi-calendar-check font-20px"></i></div>
                                Calendar
                            </a>
                            <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'clients.php') !== false) echo 'active'; ?>" href="clients.php">
                                <div class="sb-nav-link-icon"><i class="bi bi-people-fill font-20px"></i></div>
                                Clients
                            </a>
                            <a class="nav-link <?php if (strpos($_SERVER['REQUEST_URI'], 'inbox.php') !== false || strpos($_SERVER['REQUEST_URI'], 'booking-requests.php') !== false || strpos($_SERVER['REQUEST_URI'], 'chat.php') !== false) echo 'active'; ?>" href="inbox.php">
                            ...
                            <div class="collapse" id="NewsLetter" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested">
                                    <a class="nav-link" href="business-details.php">
                                        Business Details
                                    </a>
