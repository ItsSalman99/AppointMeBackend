    ...
    <main>
        <nav class="sb-topnav navbar navbar-expand bg-white justify-content-between py-3 px-3 px-md-5">
            ...
            <div class="logo-sm d-block d-lg-none">
                <img src="assets/images/logo.png" alt="" class="width-20 width-md-10 width-lg-80" draggable="false" loading="lazy">
            </div>
            <ul class="navbar-nav ms-auto me-lg-0 me-2 align-items-center gap-3">
                ...
                <li class="nav-item dropdown">
                    <div class="dropdown" style="width: 80%;">
                        <a class="nav-link dropdown-toggle caret-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="assets/images/lang.png" alt="" data-bs-toggle="tooltip" data-bs-title="Langauges">
                        </a>
                        <ul class="dropdown-menu" style="">
                            <li>
                                <a href="#.">
                                    <div class="d-flex p-2">
                                        <div>
                                            <img src="assets/images/lang.png" class="w-50">
                                        </div>
                                        <div>
                                            English
                                        </div>
                            ...
                            <li>
                                <a href="#.">
                                    <div class="d-flex p-2">
                                        <div>
                                            <img src="assets/images/spanish.png" class="w-50">
                                        </div>
                                        <div>
                                            Spanish
                                        </div>
                ...
                <li class="nav-item dropdown">
                    <div class="dropdown" style="width: 80%;">
                        <a class="nav-link dropdown-toggle caret-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="assets/images/Hicon/Linear/Message.png" alt="" data-bs-toggle="tooltip" data-bs-title="Messasges">
                        </a>
                ...
                <li class="nav-item dropdown">
                    <div class="dropdown" style="width: 70%;">
                        <a class="nav-link dropdown-toggle caret-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="assets/images/Hicon/Linear/notify.png" alt="" data-bs-toggle="tooltip" data-bs-title="Notifications">
                        </a>
                ...
                <li class="nav-item dropdown profile">
                    <a class="nav-link d-flex dropdown-toggle caret-none align-items-center gap-2 p-0" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside"> <img src="assets/images/user.png" alt="" draggable="false" loading="lazy">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 mt-2" aria-labelledby="navbarDropdown" style="--bs-dropdown-min-width: 200px">
                        ...
                        <li class="dropstart dropdown position-relative">
                            <a class="dropdown-item dropdown-toggle caret-none" href="editProfile.php">
                        ...
                        <li class="dropstart dropdown position-relative">
                            <a class="dropdown-item dropdown-toggle caret-none" href="index.php">
                                <div class="d-flex align-items-center gap-2">
