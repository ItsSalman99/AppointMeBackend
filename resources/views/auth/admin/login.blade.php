...
@section('content')
    <div class=" mb-8 text-center">
        <img src="{{ asset('assets/images/bookinglogo.png') }}" alt="" style="width: 30%;" class="mx-auto mb-3"
            ...
            <div>
                ...
                <form id="loginForm" class="mt-6">
                    ...
                    <div class="row">
                        ...
                        <div class="">
                            <div class="my-4">
                                <button type="submit" style="display: inherit;"
                                    class=" text-center btn btn-primary text-uppercase py-2 w-100">
                                    Login
                                </button>
                            </div>
                        </div>
