                        ...
                        <td style="max-width: 250px">
                            <div class=" d-flex align-items-center gap-2">
                                ...
                                <div style="width: 150px;">
                                    <a href="#" data-bs-toggle="tooltip" data-bs-title="Wayde N. Thabalanz" class=" font-14px m-0 text-truncate text-dark hover-opacity-07">Wayde N. Thabalanz</a>

                                </div>
                            </div>
                        </td>
                        <td>example@email.com</td>
                        <td>+1 (512) 4441 123</td>
